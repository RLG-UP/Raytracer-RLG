...
public class Raytracer {
    public static void main(String[] args) {
        ...
        scene.addObject(new Sphere(new Vector3D(0.7, 0, 0), 0.7, Color.lightGray,  0.4, 0));
        scene.addObject(new Sphere(new Vector3D(0, 2, 0), 1, Color.lightGray,  0.4, 0));
        ...
        Polygon polygon = new Polygon(path, new Color(220, 20, 60), 0.4, 0);
        Polygon polygon2 = new Polygon(path2, Color.lightGray, 0.4, 0);
        ...
        Light light03 = new Point(1f, Color.white, new Vector3D(-3, -5, 0));
