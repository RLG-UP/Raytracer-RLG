...
public class Camera {
    ...
    private Double[] clipPlanes = {-9999999999999999999999999999999999999999999999999999999999999999999999999.999999999999999999, -9999999999999999999999999999999999999999999999999999999999999999999999999.999999999999999999};
    ...
    public Camera(Vector3D position, Double nearPlane, Double farPlane) {
        ...
        this.setNearPlane(position.value + nearPlane);
        this.setFarPlane(position.value + farPlane);
    }
