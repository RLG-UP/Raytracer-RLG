...
/**
 * The Polygon class represents a 3D polygon composed of triangles.
 * It provides functionality to load polygon data from OBJ files, apply transformations,
 * and manage vertex, texture, and normal data.
 */
public class Polygon {
    ...
    /**
     * Constructs a Polygon with the specified list of triangles.
     *
     * @param shape The list of triangles that compose the polygon
     */
    ...
    /**
     * Constructs a Polygon by loading data from an OBJ file with the specified material.
     *
     * @param filePath The path to the OBJ file
     * @param material The material to apply to the polygon
     */
    ...
    /**
     * Constructs a Polygon by loading data from an OBJ file with the specified color and optical properties.
     *
     * @param filePath The path to the OBJ file
     * @param color The color of the polygon
     * @param refraction The refraction index of the material
    ...
    /**
     * Constructs a Polygon by loading data from an OBJ file with the specified color,
     * optical properties, and texture map.
     *
     * @param filePath The path to the OBJ file
     * @param color The color of the polygon
     * @param refraction The refraction index of the material
     * @param transparency The transparency level of the material
     * @param textureMap The texture map to apply to the polygon
     */
    ...
    /**
     * Gets the list of triangles that compose the polygon.
     *
    ...
    /**
     * Sets the list of triangles that compose the polygon.
     *
     * @param shape The list of triangles to set
     */
    ...
    /**
     * Translates the polygon by the specified amounts in each axis.
     *
     * @param tX The translation amount in the X axis
     * @param tY The translation amount in the Y axis
     * @param tZ The translation amount in the Z axis
     */
    ...
    /**
     * Scales the polygon by the specified factors in each axis.
     *
    ...
    /**
     * Rotates the polygon in place by the specified angles around each axis.
     *
     ...
     * @param inRadians Whether the angles are in radians (true) or degrees (false)
     */
    ...
    /**
     * Rotates the polygon in place by the specified angles around each axis (in degrees).
     *
     * @param rX The rotation angle around the X axis
     * @param rY The rotation angle around the Y axis
     * @param rZ The rotation angle around the Z axis
     */
    public void rotateInPlace(float rX, float rY, float rZ) {
        this.rotateInPlace(rX, rY, rZ, false);
    }

    /**
     * Rotates the polygon by the specified angles around each axis.
     *
     * @param rX The rotation angle around the X axis
     * @param rY The rotation angle around the Y axis
     * @param rZ The rotation angle around the Z axis
    ...
    /**
     * Rotates the polygon by the specified angles around each axis (in degrees).
     *
     * @param rX The rotation angle around the X axis
     * @param rY The rotation angle around the Y axis
     * @param rZ The rotation angle around the Z axis
    ...
    public void rotate(float rX, float rY, float rZ) {
        this.rotate(rX, rY, rZ, false);
    }

    /**
     * Gets the position of the polygon.
     *
     * @return The position vector of the polygon
     */
    ...
    /**
     * Adds a normal vertex to the polygon.
     *
     * @param vertex The normal vertex to add
     */
    public void addNormalVertex(Double[] vertex) {
        this.normalVertexes.add(vertex);
    }

    /**
     * Gets the list of normal vertices of the polygon.
     *
     * @return The list of normal vertices
     */
    public ArrayList<Double[]> getNormalVertexes() {
     ...
     *
     * @param vertex The texture coordinate to add
     */
    public void addTexture(Double[] vertex) {
        this.textures.add(vertex);
    }

    /**
     * Gets the list of texture coordinates of the polygon.
     *
     * @return The list of texture coordinates
     */
    public ArrayList<Double[]> getTexture() {
    ...
    /**
     * Gets the texture map of the polygon.
     *
     * @return The texture map image
     */
    ...
    /**
     * Sets the texture map of the polygon.
     *
     * @param textureMap The texture map image to set
     */
